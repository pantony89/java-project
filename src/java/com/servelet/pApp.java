 ...
 * @author c0633176
 */
public class pApp extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet pApp</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet pApp at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        Database db=new Database();
          ...
          String aptDate=request.getParameter("doa");
          String time=request.getParameter("time");
          String email=request.getParameter("email");
          String diagnosis=request.getParameter("diagno");
          
   if(ptName!=null && email!=null && docName!=null && email!=null && age!=null && diagnosis!=null){
